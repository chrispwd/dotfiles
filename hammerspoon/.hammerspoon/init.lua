...
hs.hotkey.bind({"cmd"}, "5", function() toggleApp("Docker") end)
hs.hotkey.bind({"cmd"}, "6", function() toggleApp("Sequel Ace") end)
hs.hotkey.bind({"cmd"}, "7", function() toggleApp("1Password") end)
hs.hotkey.bind({"cmd"}, "8", function() toggleApp("CoScreen") end)
hs.hotkey.bind({"cmd"}, "9", function() toggleApp("Google Chrome") end)
