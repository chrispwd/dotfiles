;;; doom-dork-theme.el --- dark theme for dorks -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: TBD
;; Author: Chris Perez <https://github.com/chrispwd>
;; Maintainer:
;; Source: https://github.com/dork-theme
;;
;;; Commentary:
;;; Code:
...
(defgroup doom-dork-theme nil
  "Options for the `doom-dork' theme."
  :group 'doom-themes)

(defcustom doom-dork-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-dork-theme
...
(def-doom-theme doom-dork
  ...
  ((bg         '("#0a0a09" nil       nil          ))
   ...
   (fg         '("#959595" "#959595" "white"))
   (fg-alt     (doom-darken fg 0.4))

   (grey       '("#605e5a" "#5a5a5a" "brightblack"))
   (red        '("#4f4f4f" "#cc6666" "red"))
   (orange     '("#988658" "#dd9955" "brightred"))
   (yellow     '("#988658" "#f0c674" "yellow"))
   (green      '("#719d72" "#b5bd68" "green"))
   (blue       '("#68668f" "#88aabb" "brightblue"))
   (teal       blue)
   (dark-blue  '("#68668f" "#41728e" "blue"))
   (magenta    '("#966894" "#c9b4cf" "magenta"))
   (violet     '("#966894" "#b294bb" "brightmagenta"))
   (cyan       '("#688891" "#8abeb7" "cyan"))
   ...
   (-modeline-pad
    (when doom-dork-padded-modeline
      (if (integerp doom-dork-padded-modeline)
          doom-dork-padded-modeline
        4))))
