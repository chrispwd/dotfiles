...
;;     :base07 "#ababab"
;;     :red "#944649"     ; red
;;     :orange "#915d1e"  ; orange
;;     :yellow "#848c21"  ; yellow
;;     :green "#007659"   ; green
;;     :cyan "#00778a"    ; cyan
;;     :blue "#005a9c"    ; blue
;;     :magenta "#786ba3" ; magenta
;;     :extra "#00778a")  ; extra
;;   "All colors for homerun are defined here.")
...
(use-package solarized-theme
  ...
  (setq solarized-use-less-bold t)
  ;; oksolar palette with custom face overrides
  (solarized-create-theme-file-with-palette 'dark 'solarized-penumbra-dark
    '("#24272b" "#fff7ed"
      ;; yellow,  orange,      red,  magenta,   violet,     blue,     cyan,    green
      "#a38f2d" "#ba823a" "#ca736c" "#bd72a8" "#9471cc" "#5794d0" "#00a2af" "#47a477")
    '((custom-theme-set-faces
       theme-name
       `(highlight ((,class (:background ,base00))))
       `(hl-line
         ((,class (:background ,base02 :extend t))))
       `(region
         ((,class (:foreground ,base2 :background ,base00 :extend t))))
       `(font-lock-keyword-face
       ...
       `(denote-faces-date ((,class (:foreground ,blue))))
       `(denote-faces-keywords ((,class (:foreground ,violet))))
       `(org-link ((,class (:foreground ,green :underline t))))
       `(org-done ((,class (:foreground ,base01 :bold t))))
       `(org-verbatim ((,class (:foreground ,blue :background ,base02))))
       `(org-code ((,class (:foreground ,magenta :background ,base02))))
       ...
       `(org-level-8 ((,class (:foreground ,red))))
       `(vertico-current ((,class (:background ,base02 :underline t)))))))
  (load-theme 'solarized-penumbra-dark t))
