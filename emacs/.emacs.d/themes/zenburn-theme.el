...
;;;;; isearch
   ...
   `(mode-line
     ((,class (:foreground ,zenburn-green+1
                           ...
                           :box (:line-width -1 :style released-button)))
      (t :inverse-video t)))
   `(mode-line-buffer-id ((t (:foreground ,zenburn-fg :weight bold))))
   `(mode-line-inactive
...
;;;;; org-mode
   ...
   `(org-verbatim ((t (:foreground ,zenburn-green+3))))
   `(org-code ((t (:foreground ,zenburn-red :background ,zenburn-bg-05))))
