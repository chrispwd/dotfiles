;;; doom-3024-theme.el --- A color scheme. -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: TBD
...
(defgroup doom-3024-theme nil
  "Options for doom-3024."
  :group 'doom-themes)

(defcustom doom-3024-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-3024-theme
  :type '(choice integer boolean))

;;
;;; Theme definition

(def-doom-theme doom-3024
 ...
 by Dutch artist Erosie."
  ...
  ((bg          '("#090300" "#000000" nil          )) ; bg1
   (bg-alt     '("#000000" "black"   nil          ))
   (bg-alt2    '("#4a4543" "DarkGray" "brown"    )) ; bg2 (for region, selection etc.)
   (base0      '("#282625" "black"   "black"      )) ; (self-defined)
   (base1      '("#282625" "#1d1d1d" "brightblack")) ; bg1
   (base2      '("#3a3432" "#282828" "brightblack")) ; bg2
   (base3      '("#4a4543" "#383838" "brightblack")) ; bg3
   (base4      '("#5c5855" "#5c5c5c" "brightblack")) ; bg4
   (base5      '("#807d7c" "#6f6f6f" "brightblack")) ; bg5 (grey)
   (base6      '("#a5a2a2" "#909090" "brightblack")) ; bg6 (fg)
   (base7      '("#d6d5d4" "#cccccc" "brightblack")) ; fg2 (fg-alt, brighter)
   (base8      '("#f7f7f7" "#fbfbfb" "brightwhite")) ; fg0 (white-white)
   (fg         '("#a5a2a2" "#dfdfdf" "brightwhite")) ; fg/fg1
   (fg-alt     '("#d6d5d4" "#cccccc" "brightwhite")) ; fg2

   ;; Base 3024 colors, plus a few extras to round out colors
   (grey        '("#807d7c" "#909090" "brightblack"))   ; grey
   (red         '("#db2d20" "#e74c3c" "red"))           ; red-red (red)
   (violet      '("#a16a94" "#cc241d" "magenta"))       ; purple
   (magenta     '("#e8bbd0" "#d3869b" "brightmagenta")) ; magenta
   (orange      '("#cdab53" "#fd971f" "orange"))        ; orange (more dark yellow)
   (yellow      '("#fded02" "#fabd2f" "yellow"))        ; yellow
   (dark-yellow '("#cdab53" "#fabd2f" "yellow"))        ; yellow (ignore)
   (teal        '("#83c092" "#8ec07c" "green"))         ; teal (not "true" 3024)
   (green       '("#01a252" "#b8bb26" "green"))         ; bright-green
   (dark-green  '("#1E6B42" "#98971a" "green"))         ; green
   (blue        '("#01a0e4" "#83a598" "brightblue"))    ; bright-blue
   (dark-blue   '("#01a0e4" "#458588" "blue"))          ; blue
   (cyan        '("#b5e4f4" "#8ec07c" "brightcyan"))    ; cyan
   (my-black    '("#282625" "#37302f" "black"))         ; bg0
   (dark-cyan   '("#b5e4f4" "#689d6a" "cyan"))          ; cyan
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-3024-padded-modeline
      (if (integerp doom-3024-padded-modeline)
          doom-3024-padded-modeline
        4)))
   (modeline-bg base0)
