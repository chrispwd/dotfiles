;;; doom-everforest-theme.el --- inspired by sainnhe's Everforest -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: May 1, 2019 (#277)
;; Author: JongW <https://github.com/JongW>
;; Maintainer:
;; Source: https://github.com/morhetz/Everforest
;;
;;; Commentary:
;;; Code:
...
(defcustom doom-everforest-dark-variant nil
...
(def-doom-theme doom-everforest
  ...
  ((bg
   ...
   (base2      '("#333c43" "#282828" "brightblack")) ; bg0
   (base3      '("#3a464c" "#383838" "brightblack")) ; bg1
   (base4      '("#555f66" "#5c5c5c" "brightblack")) ; bg3
   (base5      '("#5d6b66" "#6f6f6f" "brightblack")) ; bg4
   (base6      '("#7a8478" "#909090" "brightblack")) ; gray
   (base7      '("#859289" "#cccccc" "brightblack")) ; fg2
   (base8      '("#9DA9A0" "#fbfbfb" "brightwhite")) ; fg0
   (fg         '("#D3C6AA" "#dfdfdf" "brightwhite")) ; fg/fg1
   (fg-alt     '("#d4be98" "#cccccc" "brightwhite")) ; fg2

   ;; Standardized official colours from Everforest
   (grey        '("#7A8478" "#909090" "brightblack"))   ; gray
   (red         '("#e67e80" "#e74c3c" "red"))           ; bright-red
   (magenta     '("#d699b6" "#cc241d" "magenta"))       ; red
   (violet      '("#d3869b" "#d3869b" "brightmagenta")) ; bright-purple
   (orange      '("#e69875" "#fd971f" "orange"))        ; bright-orange
   (yellow      '("#dbbc7f" "#fabd2f" "yellow"))        ; bright-yellow
   (dark-yellow '("#d8a657" "#fabd2f" "yellow"))        ; yellow
   (teal        '("#83c092" "#8ec07c" "green"))         ; bright-aqua
   (green       '("#a7c080" "#b8bb26" "green"))         ; bright-green
   (dark-green  '("#48584e" "#98971a" "green"))         ; green
   (blue        '("#7fbbb3" "#83a598" "brightblue"))    ; bright-blue
   (dark-blue   '("#3F5865" "#458588" "blue"))          ; blue
   (cyan        '("#7fbbb3" "#8ec07c" "brightcyan"))    ; bright-aqua
   (my-black    '("#293136" "#37302f" "black"))
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-everforest-brighter-comments magenta grey))
   (doc-comments   (if doom-everforest-brighter-comments (doom-lighten magenta 0.2) (doom-lighten fg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       red)
   (methods        green)
   ...
   (-modeline-pad
    (when doom-everforest-padded-modeline
      (if (integerp doom-everforest-padded-modeline)
          doom-everforest-padded-modeline
        4)))
   (modeline-bg base0)
